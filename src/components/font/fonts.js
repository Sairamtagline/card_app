const fonts = {
	...
	google: [
		...
		{ name: 'Alef', type: 'sans-serif', ref: 'google' },
		{ name: 'Jokerman', type: 'sans-serif', ref: 'google' },
		{ name: 'Heebo', type: 'sans-serif', ref: 'google' },
		{ name: 'Rubik', type: 'sans-serif', ref: 'google' },
		{ name: 'Varela Round', type: 'sans-serif', ref: 'google' },
		{ name: 'Assistant', type: 'sans-serif', ref: 'google' },
		{ name: 'Secular One', type: 'sans-serif', ref: 'google' },
		{ name: 'Rounded Mplus 1c', type: 'sans-serif', ref: 'google' },
		{ name: 'Mplus 1p', type: 'sans-serif', ref: 'google' },
		{ name: 'Frank Ruhl Libre', type: 'sans-serif', ref: 'google' },
		{ name: 'Suez One', type: 'sans-serif', ref: 'google' },
		{ name: 'Karantina', type: 'sans-serif', ref: 'google' },
		{ name: 'David Libre', type: 'sans-serif', ref: 'google' },
		{ name: 'Bellefair', type: 'sans-serif', ref: 'google' },
		{ name: 'Miriam Libre', type: 'sans-serif', ref: 'google' },
	],
};
